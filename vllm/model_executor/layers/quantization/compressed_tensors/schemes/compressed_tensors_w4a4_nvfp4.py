...
class CompressedTensorsW4A4Fp4(CompressedTensorsScheme):
    ...
    def __init__(self):
        ...
        elif has_flashinfer() and False:
            self.backend = "flashinfer-cutlass"
        else:
            self.backend = "cutlass"
            print("using Cutlass BACKEND!!!!!!!")
        self.group_size = 16
    ...
    def apply_weights(
        ...
        if self.backend == "fbgemm":
            ...
            # x_fp4, x_blockscale = triton_scale_nvfp4_quant(
            #     x, layer.input_global_scale, rounding_mode=4
            # )
        else:
            x_fp4, x_blockscale = scaled_fp4_quant(x, layer.input_global_scale)
        mm_args = (
